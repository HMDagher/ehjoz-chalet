    ...
    <div class="header__top">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="location">
                        <a class="link__item gap-10" href="#"><i class="flaticon-marker"></i>{{ optional($settings)->address ?? 'M5T 2L9 Toronto, Canada' }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="main__header__wrapper">
                    ...
                    <div class="main__logo">
                        <a href="{{route('index')}}"><img class="logo__class" src="{{ asset(optional($settings)->site_logo ?? 'assets/images/logo/logo.svg') }}" alt="{{ optional($settings)->site_name ?? 'Moonlit' }}"></a>
                    </div>
