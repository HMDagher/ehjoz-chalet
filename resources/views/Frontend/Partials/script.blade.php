...
<!-- plugin js -->
<script src="{{ asset('assets/js/plugins.min.js') }}?v={{ filemtime(public_path('assets/js/plugins.min.js')) }}"></script>
<script src="{{ asset('assets/js/gdpr.js') }}?v={{ filemtime(public_path('assets/js/gdpr.js')) }}"></script>
<!-- custom js -->
